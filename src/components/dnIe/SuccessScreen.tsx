      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 animate-fade-in">
            Your digital identity has been verified
          </p>
        </div>
          ...
          <div className="text-center space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-green-700 font-medium">Verified & Authenticated</span>
              </div>
            </div>

            <div className="pt-4 border-t border-gray-100">
              <div className="text-sm text-gray-500 mb-2">Redirecting in 3 seconds...</div>
        ...
        <Card className="p-4 bg-blue-50 border border-blue-200">
          <div className="text-center">
            <h3 className="font-medium text-blue-800 mb-1">Secure Session</h3>
